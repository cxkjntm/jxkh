...
$sql = "SELECT UserID,UserName,DeptName,DeptInfo.DeptID FROM DeptInfo, UserInfo WHERE UserInfo.DeptID=DeptInfo.DeptID AND Rank<4 LIMIT 120,30";
...
?>
		...
		<div class="layui-form-item layui-col-xs-offset6">
        	<a href="" class="layui-btn" onclick="test()">提交成功</a>
        </div>
	</form>
</body>
<script> 
