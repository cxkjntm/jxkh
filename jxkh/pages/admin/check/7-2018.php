...
$sql = "SELECT DeptName,DeptID FROM deptinfo where DeptID>16 and DeptID<34";
...
$rs=mysql_fetch_array($result);
 while($row=mysql_fetch_row($result)){          //While()的作用是将指针向后移动，将下一行的数据交给$row
		...
		echo "<td> <input  name='".$row[1]."' type='radio'checked='checked' value='0'></td>";
