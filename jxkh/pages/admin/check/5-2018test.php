...
//查询该部门的中层领导有多少位
$sql2 = "SELECT COUNT(Rank)as number FROM userinfo WHERE DeptID=".$rs['DeptID']." AND Rank=2 GROUP BY Rank;";
$result2=(mysql_query($sql2,$connjxkh));
while($row1 = mysql_fetch_array($result2))
echo "<input id='number1' name='number' type='hidden' value='".$row1['number']."'/>";

$sql3 = "SELECT COUNT(Rank)as number FROM userinfo WHERE DeptID=".$rs['DeptID']." AND Rank=3 GROUP BY Rank;";
