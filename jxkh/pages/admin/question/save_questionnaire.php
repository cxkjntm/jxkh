...
<?php
	...
	//存入问卷
	$sql="INSERT INTO voterecord(RecordName,RecordCode,starttime,endtime,status,describtion,welcome,end) VALUES ('$recordname','$recordcode','$starttime','$endtime' ,'$status','$description','$welcome','$end')";	
	//echo $sql;
