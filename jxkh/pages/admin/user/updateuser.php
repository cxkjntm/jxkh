...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE UserInfo SET UserName=%s, Passwd=%s, Photo=%s, DeptID=%s, Rank=%s, IsEvaluated=%s, IsPj=%s WHERE UserID=%s",
                       ...
                       GetSQLValueString($_POST['IsEvaluated'], "int"),
                       GetSQLValueString($_POST['IsPj'], "int"),
...
<div class="layui-col-md1"><span class="layui-bg-gray">&nbsp;</span></div>
 ...
 <div class="layui-form-item">
       <span class="layui-bg-gray">
       <label class="layui-form-label layui-card">是否参评</label>
       </span>
       <div class="layui-input-block">
         <span class="layui-bg-gray">
           <input type="text" name="IsEvaluated" value="<?php echo htmlentities($row_rsUser['IsEvaluated'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="layui-input" >        
        </span></div>                  
   </div>
...
<div class="layui-col-md1"><span class="layui-bg-gray">&nbsp;</span></div>
 <div class="layui-col-md3">
 	<div class="layui-form-item">
       <span class="layui-bg-gray">
       <label class="layui-form-label layui-card">是否评价</label>
       </span>
       <div class="layui-input-block">
         <span class="layui-bg-gray">
           <input type="text" name="IsPj" value="<?php echo htmlentities($row_rsUser['IsPj'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="layui-input" >        
        </span></div>                  
   </div>
 </div>
 <div class="layui-col-md6"><span class="layui-bg-gray">&nbsp;</span></div>
