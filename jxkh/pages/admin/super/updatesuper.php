...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  if($Result1)
	  echo "<script type='text/javascript'>layer.msg('管理员修改成功，关闭页面后请刷新主页面！');</script>";
}

$colname_rsSuper = "2";
if (isset($_POST['SuperID'])) {
  $colname_rsSuper = $_POST['SuperID'];
}
mysql_select_db($database_connjxkh, $connjxkh);
 ...
 <div class="layui-col-md4">
 	<div class="layui-form-item">
       ...
       <div class="layui-input-block">
         <span class="layui-bg-gray">
           <input type="text" name="SuperName" value="<?php echo htmlentities($row_rsSuper['SuperName'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="layui-input" >         		       
         </span></div>                  
  	</div> 
 </div>
...
<div class="layui-row "> 
 <div class="layui-col-md4">
 	<div class="layui-form-item">
       ...
       <div class="layui-input-block">
         <span class="layui-bg-gray">
           <input type="text" name="SuperPwd" value="<?php echo htmlentities($row_rsSuper['SuperPwd'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="layui-input" >        		       
         </span></div>                  
  	</div> 
 </div>
 <div class="layui-col-md6"><span class="layui-bg-gray">&nbsp;</span></div>
...
<div class="layui-row "> 
 <div class="layui-col-md4">
 	<div class="layui-form-item">
       ...
       <div class="layui-input-block">
         <span class="layui-bg-gray">
           <input type="text" name="SuperMemo" value="<?php echo htmlentities($row_rsSuper['SuperMemo'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="layui-input" >         		       
         </span></div>                  
  	</div> 
 </div>
 <div class="layui-col-md6"><span class="layui-bg-gray">&nbsp;</span></div>
