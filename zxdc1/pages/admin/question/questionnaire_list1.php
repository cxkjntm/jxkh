...
<a class="layui-btn layui-btn-xs" lay-event="edit">设置修改</a>
  <a class="layui-btn layui-btn-xs" lay-event="preview">问卷预览</a>
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="modi">问卷题目</a>
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="start">启动调查</a>
  ...
  //第一个实例
   var tableIns =table.render({
	...
	{field: 'RecordID', title: 'ID', width:50, sort: true, fixed: 'left'}
       ,{field: 'RecordCode', title: '问卷编号', width:100, sort: true, fixed: 'left'}
	   ,{field: 'RecordName', title: '问卷主题', width:255}
  ...
  table.on('tool(test)', function(obj){
    ...
    if(obj.event === 'modi'){
      var RecordID=data.RecordID;
        			...
        			area: ['1100px', '790px'],
        			shift: 2,
        			content: 'questionlist.php?RecordID='+RecordID //iframe的url
      			});    
				} 
        			...
        			area: ['600px', '790px'],
        			shift: 2,
        			content: 'questionView.php?RecordID='+RecordID //iframe的url
     			 });
    		 }
