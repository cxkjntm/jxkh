...
layui.use(['table', 'layer', 'form'], function(){
 var form = layui.form
  ...
  table.render({
    ...
    ,cols: [[ //表头
      {field: 'AdminID', title: 'ID', width:50, sort: true, fixed: 'left'}
      ,{field: 'Account', title: '账号', width:100}
      ,{field: 'Passwd', title: '密码', width:350}
      ,{field: 'DeptName', title: '单位', width:300}  
  ...
  table.on('tool(test)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        ...
        area: ['600px', '450px'],
        shift: 2,
        content: 'updatesuper.php?AdminID='+AdminID //iframe的url
      });
    }
  });
