...
<div class="layui-main">
  ...
  <div class="layui-row layui-col-lg-offset2">
    ...
    <div class="layui-col-md8 ayui-col-space1">
      <form class="layui-form layui-form-pane"  method="post" action="checkresulttable.php">      
        <div class="layui-form-item">
          <label class="layui-form-label">综合考核期次</label>
		...
		<div class="layui-form-item">
          ...
          <div class="layui-input-inline">
            <select name="voteitem" id="voteitem"   lay-verify="required" lay-filter="voteitem">
              <option value="0">请选择项目</option>
			  <option value="1">中层领导班子</option>
...
layui.use(['form', 'jquery'], function(){
    ...
    //get Depts
    function getIssue() {
        $.getJSON("getissue1.php", function (data) {
           
            var optionStr = "";
            $.each(data, function (infoIndex, info) {                
                optionStr += '<option value="' + info["RecordCode"] + '">' + info["RecordName"] + '</option>';
                //alert(optionStr);
            });
